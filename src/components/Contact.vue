...
<div class="success">
  <span>Your message was successfully sent. <br><br><br> Thank you! </span>
...
<div v-else>
  <form ref="form" @submit.prevent="handleSubmit">
        <input type="text" placeholder="Firstname*" v-model="firstname" name='firstname'  @blur="v$.firstname.$touch" required>
          <div v-if="v$.firstname.$error" class="error">This field is required.</div>
        
        <input type="text" placeholder="Lastname*" v-model="lastname" name='lastname'  @blur="v$.lastname.$touch" required> 
                  <div v-if="v$.lastname.$error" class="error">This field is required.</div>
                <input type="text" placeholder="Company name*" v-model="business" name='business'  @blur="v$.business.$touch" required> 
                  <div v-if="v$.lastname.$error" class="error">This field is required.</div>
        <input type="email" placeholder="Email*" v-model="email" name='email' @blur="v$.email.$touch" required>
                  <div v-if="v$.email.$error" class="error">Please enter a valid email address.</div>
       
        <input type="tel" placeholder="Phone number*" v-model="tel" name='tel'  @blur="v$.tel.$touch" required>
                  <div v-if="v$.tel.$error" class="error">Please enter a valid phone number.</div>
        ...
        <textarea name="message" id="message" cols="30" rows="10" placeholder="Your message *" v-model="message" @blur="v$.message.$touch" required></textarea>
                  <div v-if="v$.message.$error" class="error">This field is required.</div>
